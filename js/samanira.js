...
$('.signup-overlay-bttn').on('click', function(){
  $('.overlay.signup-overlay').toggleClass('active');
  $('body').addClass('hidden-overflow');
});

$('.video-overlay-bttn').on('click', function(){
  $('.overlay.video-overlay').toggleClass('active');
  $('body').addClass('hidden-overflow');
});
